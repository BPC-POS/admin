...
import { Category, Product, Size } from '@/types/product'; // Import Size type here
...
const PosPage = () => {
  ...
  const handleConfirmEditTable = async (tableData: any) => {
  ...
  const showSnackbar = (message: string, severity: 'success' | 'error' | 'info') => { // Added 'info' to severity type
      ...
      <Grid container spacing={3}> 
          ...
          <Grid item xs={12} md={3}>
                <SummaryPOS
                  ...
                  onUpdateQuantity={function (productId: number, quantity: number): void {
                    throw new Error('Function not implemented.');
                  } }
                  onRemoveItem={function (productId: number): void {
                    throw new Error('Function not implemented.');
                  } }
